...
tableVacc_postOp_mortality_30day <- 
  myData_noConstraints_vacc %>% dplyr::group_by(surgery_pre_or_post_vaccine_UK,
...
write.csv(
  x = tosave,
  file = here::here("output","table_Vaccination_status.csv")
)
rm(tosave)
# Make kable table.
df_Vacc %>%
  ...
  #kableExtra::save_kable(file = here::here("output","Tables_pretty","TableVacc.png"))
# ----
