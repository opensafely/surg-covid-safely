...
# indicatio of a SARS-CoV-2 infection.
#
#
...
#############################################################
# ----
tableVacc_postOp_mortality_30day_3mths <- tableVacc_postOp_mortality_30day
write.csv(
  x = tableVacc_postOp_mortality_30day,
  file = here::here("output","tableVacc_postOp_mortality_30day_3mths.csv")
)
# ----
...
#kableExtra::save_kable(file = here::here("output","Tables_pretty","TableVacc_3mths.png"))

# Save data frame.
df_Vacc_3mths <- data.frame(" " = 
...
write.csv(
  x = df_Vacc_3mths,
  file = here::here("output","table_Vaccination_status_3mths.csv")
)
