...
study = StudyDefinition(
    ...
    COVID_first_vaccination_SNOMED = patients.with_these_clinical_events(
        ...
        on_or_before = "date_latest_test_preOp_SARS_CoV_2_outcome_any",
    ...
    ## ## Using with_tpp_vaccination_record() function.
    ## Date of first COVID vaccination.
    COVID_first_vaccination_TPP_date = patients.with_tpp_vaccination_record(
    ...
    ## Indicator of second COVID vaccination.
    COVID_additional_vaccination_TPP = patients.with_tpp_vaccination_record(
        target_disease_matches = "SARS-2 CORONAVIRUS",
        between = ["COVID_first_vaccination_TPP_date + 19 days",
                   "date_latest_test_preOp_SARS_CoV_2_outcome_any"],
        returning = "binary_flag"
    ),
